...
function displayPics(){
  ...
  // In the above problem the reason why there's an error is due to the fact let only applies to the inside the function. and would be switched to var. Because var would apply to the function as a whole.
